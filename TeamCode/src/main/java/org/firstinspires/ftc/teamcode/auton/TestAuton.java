...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Autonomy: Test Auton", group="Autonomy")
public class TestAuton extends ScheleteAutonomie {
...
//        sleep(5000);
        ...
        /*
        posibil cod de revenire la pozitie initiala
        hardware.servo180.setPosition(Specifications.servo_180_pos_up);
        sleep(500);
        if(!hardware.mCremaliera.isBusy()){
            cremalieraMovement(0);
        }
        if(!hardware.mGlisLeft.is
        Busy() && !hardware.mGlisRight.isBusy()){
            goToPos(100);
        }
        */
