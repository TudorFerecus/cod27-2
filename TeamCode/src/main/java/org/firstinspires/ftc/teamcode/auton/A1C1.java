...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Autonomy: Albastru 1 C1", group="Autonomy")
public class A1C1 extends ScheleteAutonomie {
    ...
    public void runOpMode() {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(new Pose2d(-36, 36, Math.toRadians(-90)))
                .back(7)
                .build();
